...
The `com.lingmoos.LingmoPanel` directory contains a key called entries, which is a list of profiles to be loaded. 
Each profile then has its own directory, for example, `com.lingmoos.LingmoPanel.Panel`. 
...
https://github.com/Matrinsoft/lingmo-applets  
