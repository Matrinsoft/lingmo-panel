...
#[proxy(
    default_service = "com.lingmoos.LingmoNotificationsSocket",
    interface = "com.lingmoos.LingmoNotificationsSocket",
    default_path = "/com/lingmoos/LingmoNotificationsSocket"
)]
